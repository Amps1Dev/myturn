...
const navigation = [
  ...
  },
  {
    ...
    href: '/company/branch/queue',
    icon: Users,
  },
  {
    name: 'Analytics',
    href: '/company/branch/analytics',
    icon: BarChart3,
  },
  {
    name: 'Settings',
    href: '/company/branch/settings',
    icon: Settings,
  },
  {
    name: 'Customer Feedback',
    href: '/company/branch/suggestions',
    icon: MessageSquare,
  },
];
        ...
        <div className="fixed inset-y-0 left-0 w-64 bg-card border-r border-border">
          <div className="flex items-center justify-between p-4 border-b border-border">
            <Link href="/company/dashboard" className="flex items-center space-x-2">
              ...
              <span className="text-lg font-bold">MyTurn Business</span>
            </Link>
            <Button
              variant="ghost"
              size="icon"
            ...
            <div className="flex items-center gap-x-4 lg:gap-x-6">
              ...
              <div className="flex items-center space-x-2">
                <div className="w-8 h-8 bg-gradient-to-r from-primary to-secondary rounded-full flex items-center justify-center">
                  <span className="text-sm font-medium text-primary-foreground">ZB</span>
                </div>
                <div className="hidden sm:block">
                  <p className="text-sm font-medium">Zanaco Bank</p>
                  <p className="text-xs text-muted-foreground">Cairo Road Branch</p>
                </div>
              </div>
            </div>
          </div>
